...
AddEventHandler('ef-jobreceipt:Client:OpenFormMechanic', function(form)
    ...
    local input = lib.inputDialog("Mechanic", {
        { type = 'input',        label = 'Customer Name',            description = 'Write your name here',               required = true, icon = 'fa-user' },
        { type = 'input',        label = 'Vehicle Name',             description = 'Write buyer name here',                required = true, icon = 'fa-user' },
        { type = 'input',        label = 'Customer Citizen ID',          description = 'Write buyer Citizen ID here',             required = true, icon = 'fa-id-card' },
        { type = 'input',        label = 'Have the Customer Upgrade Their Vehicle ?',            description = '( Yes or No )',     required = true, icon = 'fa-wrench' },
        { type = 'number',        label = 'Vehicle Upgrade Cost', description = 'Write vehicle selling price here',        required = true, icon = 'fas fa-dollar-sign' },
        { type = 'input',        label = 'Have the Customer Repair Their Vehicle ?',    description = '( Yes or No )', required = true, icon = 'fa-wrench' },
        { type = 'number',        label = 'Vehicle Repair Cost',            description = 'Write the down payment here',     required = true, icon = 'fas fa-dollar-sign' },
        { type = 'input',        label = 'Have the Customer Customize Their Vehicle ?',            description = '( Yes or No )',     required = true, icon = 'fa-wrench' },
        { type = 'number',        label = 'Vehicle Customize Cost',            description = 'Write the down payment here',     required = true, icon = 'fas fa-dollar-sign' },
        { type = 'input',        label = 'Mechainc Name',            description = 'Write the down payment here',     required = true, icon = 'fas fa-dollar-sign' },
    })
if input then
    if Config.Emotes == "dpemotes" then TriggerEvent('animations:client:EmoteCommandStart', {Config.Animation}) elseif Config.Emotes == "rpemotes" then exports["rpemotes"]:EmoteCommandStart(Config.Animation) else print("Missing or write wrong on: Config.Emotes") end
    lib.progressCircle({
